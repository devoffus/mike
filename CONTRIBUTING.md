...
Thanks for helping improve Courier. Please keep contributions small, focused, and easy to review.
...
`metadata.courier-availability` to `system`, put workflow instructions in the body
...
Do not open a public issue for security vulnerabilities. Use [GitHub's private vulnerability reporting](https://github.com/Open-Legal-Products/courier/security/advisories/new) instead.
