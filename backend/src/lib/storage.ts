/**
 * Cloudflare R2 storage utilities for Courier document management.
 ...
 *   R2_BUCKET_NAME      — bucket name (default: "courier")
 */
...
const BUCKET = process.env.R2_BUCKET_NAME ?? "courier";
