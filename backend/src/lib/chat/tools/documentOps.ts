...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <cp:lastModifiedBy>Courier</cp:lastModifiedBy>
...
async function buildPptxPresentation(title: string, slidesInput: unknown[]) {
  ...
  const rawSlides = slidesInput.length
    ? slidesInput
    : [{ title, bullets: ["Generated by Courier"] }];
...
<p:sldLayout xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" type="blank">
  ...
  zip.file(
    ...
    `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="Courier">
  <a:themeElements>
...
> {
  ...
  const {
    ...
    changes,
    errors,
  } = await applyTrackedEdits(current.bytes, edits, { author: "Courier" });
